    ...
    init(dict : Dictionary<String, Any>) {
        if let arr = dict["response"] as? Array<Dictionary<String, Any>> {
            for dict in arr {
                ...
                dictArray.application_id = dict["application_id"] as? String ?? "NA"
                ...
                dictArray.atfault_claimno = dict["atfault_claimno"] as? String ?? "NA"
                ...
                dictArray.expected_delivery_date = dict["expected_delivery_date"] as? String ?? "NA"
                ...
                dictArray.owner_firstname = dict["owner_firstname"] as? String ?? "NA"
                dictArray.owner_lastname = dict["owner_lastname"] as? String ?? "NA"
                dictArray.owner_registration_no = dict["owner_registration_no"] as? String ?? ""
                dictArray.referral_name = dict["referral_name"] as? String ?? ""
                dictArray.repairer_name = dict["repairer_name"] as? String ?? "NA"
                dictArray.owner_lic = dict["owner_lic"] as? String ?? "NA"
