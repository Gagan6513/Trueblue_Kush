...
let diliverydateRequired = "Please select expected delivery date"
...
let selectBranch = "Please select branch"
let firstName = "Please first name"
let lastName = "Please last name"
let email = "Please email"
let phone = "Please phone"
let recoverFor = "Please select recover for"
let isVehicleBusinessRegistered = "Please select your vehicle business registered or not?"
let isCarDrivable = "Please select your car drivable or not"
let street = "Please enter street"
let suburb = "Please enter suburb"
let state = "Please enter state"
let country = "Please enter country"
let pinCode = "Please enter pin code"
let makeModel = "Please enter Make/Model"
let registrationNo = "Please enter registration no"
let insurancecompany = "Please select insurance company"
let claimNo = "Please select claim no"
let dateofBirth = "Please enter date of birth"
let dateofAccident = "Please enter date of accident"
let timeofAccident = "Please enter time of accident"
let accidentLocation = "Please enter accident location"
let referralName = "Please enter referral name"
let repairerName = "Please enter repaire name"
let viewAccidentDescription = "Please enter accident description"
